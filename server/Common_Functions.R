...
bootstrap <- function(data, direct_fun, ensemble_fun, sample.percentage, iterations,topk,params){
  ...
  vars=list(direct_fun,"norm_mat","write_file","dir_direct_bootstrap","dir_direct_bootstrap_uppertri","pcor.shrink","space.joint","skeleton_stable","zStat","pc_stable","gaussCItest","getNextSet","udag2pdagRelaxed","idaFast")
