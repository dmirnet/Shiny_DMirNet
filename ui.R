        ...
        tabsetPanel(type = "tabs",
          ...
          tabPanel("Experiments", 
           ...
           column(3,
            ...
            checkboxInput('silencing', 'Silencing '),
                ...
                column(3, 
                 ...
                 column(3,
                  hidden(
                    div(
                      id="divsilence",
                      h4("Parameters selection for Silencing (Optional)"),
                        sliderInput("silence_norm","Norm (0-1)","0.5",min=0,max=1),
                        sliderInput("silence_max","Maximum (0-1)","0.9",min=0,max=1),
                        sliderInput("silence_min","Minimum (0-1)","0.5",min=0,max=1)
                      )
                    )
                  ),
                column(3, 
